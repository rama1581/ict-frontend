...
import { FaWifi, FaUserGraduate, FaUserTie, FaShieldAlt, FaArrowLeft } from 'react-icons/fa';
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg">
                                <FaUserGraduate size={24} className="text-indigo-500 flex-shrink-0 mt-1" />
                                <div>
                             ...
                             <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg">
                                <FaUserTie size={24} className="text-indigo-500 flex-shrink-0 mt-1" />
                                <div>
